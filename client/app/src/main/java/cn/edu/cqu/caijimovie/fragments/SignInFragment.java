...
public class SignInFragment extends MyFragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        linearLayout = (LinearLayout) getActivity().findViewById(R.id.signinLinear);
...
//                        getActivity().finish();
                        ...
                        if (usermailstr == null || usermailstr.equals("") || userpasswordstr == null || userpasswordstr.equals("")) {
                            ...
                            Snackbar.make(linearLayout, "用户名或密码为空", LENGTH_SHORT).show();
...
//                                                    SystemClock.sleep(2000);
                                                ...
                                                case 1:
                                                    ...
                                                    Snackbar.make(linearLayout, "账号不存在", LENGTH_SHORT).show();
                                                    Looper.loop();
                                                    break;
                                                case 2:
                                                    Log.i("登录状态", "json对象: " + logstatus);
                                                    ...
                                                    Snackbar.make(linearLayout, "密码错误", LENGTH_SHORT).show();
                                                    Looper.loop();
                                                    break;
                                                case -1:
                                                    Looper.prepare();

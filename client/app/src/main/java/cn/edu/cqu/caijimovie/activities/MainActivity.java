...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        Fragment framentHome = new MainHomeFragment();
        framentHome.setArguments(bundle);
        Fragment framentRec = new MainRecommendFragment();
        framentRec.setArguments(bundle);
        Fragment framentMe = new MainMeFragment();
        framentMe.setArguments(bundle);
        adapter.addFragment(framentHome);
        adapter.addFragment(framentRec);
        adapter.addFragment(framentMe);
